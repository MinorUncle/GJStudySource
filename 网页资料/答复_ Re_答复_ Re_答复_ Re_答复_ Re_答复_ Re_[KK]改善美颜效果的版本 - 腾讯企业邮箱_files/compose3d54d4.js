...
{
var e=getTop().S(f[h],window);
if(e)
{
var c=(a==f[h])?1:0;
getTop().S(g[h],window).className=d[c];
getTop().show(e,c);
}
}
}
...
var b,d=getPageId();
var c=QMAttach.getExistList(),e=c.length?QMAttach.getExistInfos()[c[c.length-1]]._sMode:"";
if(("compose"==d||"group"==d)&&"save"!=a.actiontype.value&&"tradition"!=e&&"ie"!=e&&"1"==getTop().gbBackGroundSend&&(b=getTop().BackGroundSend))
{
