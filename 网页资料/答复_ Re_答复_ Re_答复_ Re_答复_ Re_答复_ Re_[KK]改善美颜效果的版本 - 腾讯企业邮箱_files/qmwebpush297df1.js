...
_oQMWebpush._LOGIC_POLL={_moProxyWin:null,_mbCreatingProxy:false,_moLongConnectAjax:null,_mbLongConnecting:false,_msKey:null,_msTime:"0",_mnOpenServices:0,_moEventList:[],_ABORTTIME:30,_POLL:"/poll",_PROXY_URL:"/zh_CN/htmledition/domain_admin.html?"+location.host+"&v=110701",open:function(_anServices){
var _oSelf=this;
...
{
_oQMWebpush.debug(["poll1",_oSelf._mnOpenServices,_oSelf._mbLongConnecting]);
return _oSelf;
}
if(!_oSelf._moLongConnectAjax)
{
_oQMWebpush.debug(["poll2"]);
return _oSelf._createProxy();
}
if(!_oSelf._msKey)
{
_oQMWebpush.debug(["poll3"]);
